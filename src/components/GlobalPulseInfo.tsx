    ...
    <Card className="p-4 border-primary/20 cyber-glow h-[600px] flex flex-col">
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="text-center p-2 rounded-lg bg-muted/30">
          <div className="text-lg font-bold text-primary mb-1">{alerts.length}</div>
          <div className="text-xs text-muted-foreground">Pulsos Ativos</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-muted/30">
          <div className={`text-lg font-bold mb-1 ${intensityInfo.color}`}>
            {globalIntensity}%
          </div>
          <div className="text-xs text-muted-foreground">Intensidade</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-muted/30">
          <div className="text-lg font-bold text-primary mb-1">{Math.floor(Math.random() * 50) + 120}</div>
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        <div className="flex flex-col items-center p-2 rounded-lg bg-destructive/10">
          <div className="w-2 h-2 rounded-full bg-destructive mb-1"></div>
        ...
        <div className="flex flex-col items-center p-2 rounded-lg bg-warning/10">
          <div className="w-2 h-2 rounded-full bg-warning mb-1"></div>
