...
const threats: ThreatData[] = [
  {
    id: "1",
    name: "Breakthrough Quântico Chinês",
    ...
    description: "Potencial breakthrough em computação quântica que pode tornar obsoleta a criptografia atual.",
    countermeasures: ["Acelerar P&D em criptografia pós-quântica", "Parcerias estratégicas urgentes", "Revisão de protocolos de segurança"]
  },
  {
    id: "2",
    name: "Regulação IA na Europa",
    ...
    severity: "alto",
    region: "Europa",
    description: "Nova legislação europeia pode impactar drasticamente desenvolvimento e deployment de IA.",
    countermeasures: ["Compliance proativo", "Lobby técnico", "Redesign de produtos"]
  },
  {
    id: "3",
    name: "Disrupção em Baterias",
    ...
    description: "Startup emergente com tecnologia de bateria sólida 10x mais eficiente.",
    countermeasures: ["Análise técnica profunda", "Potencial aquisição", "Aceleração de P&D interno"]
  },
  {
    id: "4",
    name: "Escassez de Terras Raras",
    ...
    severity: "alto",
    region: "Global",
    description: "Tensões geopolíticas podem restringir acesso a elementos críticos para tecnologia.",
    countermeasures: ["Diversificação de fornecedores", "Materiais alternativos", "Reciclagem avançada"]
  },
  {
    id: "5",
    name: "Ciberataque Setorial",
    category: "Segurança",
    probability: 65,
    impact: 85,
    timeToImpact: 30,
    severity: "crítico",
    region: "Global",
    description: "Evidências de preparação para ataque coordenado contra infraestrutura de P&D.",
    countermeasures: ["Hardening imediato", "Backup offline", "Simulação de resposta"]
  },
  {
    id: "6",
    name: "Deflação Tecnológica",
    category: "Mercado",
    probability: 55,
    impact: 70,
    timeToImpact: 180,
    severity: "médio",
    region: "Global",
    description: "Commoditização acelerada de tecnologias emergentes pode erodir margens.",
    countermeasures: ["Diferenciação por software", "Serviços de valor agregado", "Novos modelos de negócio"]
  }
];
