...
const mockAlerts: AlertData[] = [
  ...
  // === ALERTAS NUCEL - AMEAÇA MVNO ===
  {
    id: "nc-1",
    type: "red",
    title: "NuCel MVNO - Ameaça Disruptiva Confirmada",
    description: "Nubank oficializa NuCel: MVNO com planos pré-pagos R$ 25/mês, cashback e benefícios exclusivos para 90M+ clientes. Combo cartão + conta + celular revoluciona mercado.",
    region: "Brasil",
    urgency: 95,
  ...
  },
  {
    id: "nc-2",
    type: "red",
    title: "Nubank Ecossistema Completo - Super App",
    description: "NuCel integra cashback, Pix grátis ilimitado e descontos no Nubank Shopping. Ecossistema completo financeiro + telecom ameaça ISPs tradicionais.",
    region: "São Paulo",
    urgency: 92,
  ...
  },
  {
    id: "nc-3",
    type: "yellow",
    title: "ISPs Regionais - Gap Estratégico Crítico",
    description: "ISPs tradicionais não possuem portfólio de serviços financeiros para competir com combos Nubank. Necessário resposta estratégica urgente para manter competitividade.",
  ...
  },
  {
    id: "nc-4",
    type: "blue",
    title: "Athon Telecom - Janela MVNO ABC",
    description: "Oportunidade estratégica para Athon desenvolver MVNO próprio com foco em combos internet + mobile para base instalada ABC. Janela de 6-12 meses antes de novos competidores.",
    region: "São Bernardo do Campo",
    urgency: 85,
