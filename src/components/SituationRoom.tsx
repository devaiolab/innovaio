...
const mockAlerts: AlertData[] = [
  ...
  // === ALERTAS NUCEL - AMEAÇA MVNO ===
  {
    ...
    description: "Nubank lança NuCel oficialmente em 29/out/2024: MVNO na rede Claro, planos a partir de R$ 45/mês (15GB), R$ 55 (20GB), R$ 69 (30GB) para 110M clientes. Chip físico lançado jul/2025.",
    region: "Brasil",
    urgency: 95,
  ...
  },
  {
    ...
    description: "Janela estratégica para Athon desenvolver MVNO competindo com NuCel R$ 45-69: base instalada qualificada ABC, potencial 15% receita adicional via combos convergentes R$ 109-169.",
    region: "São Bernardo do Campo",
    urgency: 85,
